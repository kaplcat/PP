    ...
    <div className="relative h-[80vh] w-full overflow-hidden bg-primary">
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1600596542815-e32c8cc13bc9?q=80&w=2600&auto=format&fit=crop')" }}
        />
      ...
      <div className="relative z-10 h-full flex flex-col justify-center max-w-[1600px] mx-auto px-6 md:px-12 pt-20">
        <div className="max-w-5xl">
          <div className="flex items-center gap-6 mb-8 animate-fade-in-up opacity-0" style={{ animationDelay: '0.2s' }}>
            ...
            <span className="text-gray-200 uppercase tracking-[0.4em] text-[10px] md:text-xs font-sans font-medium">Коллекция домов</span>
          </div>
          ...
          <p className="mt-8 text-gray-300 font-light text-lg md:text-xl max-w-2xl leading-relaxed animate-fade-in-up opacity-0" style={{ animationDelay: '0.6s' }}>
            Современное прочтение классических форм. Панорамное остекление, натуральный камень и функциональные планировки для разных сценариев жизни.
          </p>
        </div>
      </div>
